  ...
  },
  {
    ...
    events: [
      ...
      { code: 'D', name: '대한상공회의소·포브스 사회공헌대상', date: '2026-05-27', status: 'closed',
        ...
        place: '더 플라자호텔' },
      { code: 'E', name: '대한민국 CEO 리더십 경영대상', date: '2026-06-26', status: 'closed',
        desc: '사회적 책임 배점 500 · 5종 중 유일하게 CEO 개인을 조명',
        host: '주최 월간중앙, 중앙일보 · 주관 월간중앙 사무국 · 후원 포브스코리아',
        place: '더 플라자호텔 다이아몬드홀(22F)' },
    ],
    ...
    cautions: [
      ...
      '행사별 주최·주관·후원기관을 혼동하지 않음 (CEO 리더십 경영대상은 포브스가 후원이다)',
      '참가비·비용은 언급하지 않음',
    ],
    closings: [
      '수상 이력은 고객이 브랜드를 판단할 때 신뢰 근거로 활용될 수 있습니다.',

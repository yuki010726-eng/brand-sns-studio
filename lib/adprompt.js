...
export const AD_CONCEPTS = [
   ...
   */
  {
    ...
    desc: '검정·금박·레드 리본과 대형 혜택 문구로 신뢰를 화려한 행사감으로 바꾸는 배너',
    swatch: ['#120D0A', '#F3B832', '#D91F26'],
    person: false,
    usesEmblem: true,
    ...
    palette: 'deep near-black #120D0A background, metallic gold #F3B832, ceremonial red #D91F26, warm ivory #FFF4D6 for text, restrained white highlights only',
    art: 'a spectacular Korean premium direct-response event poster with metallic gold foil rays, subtle gold particles, restrained star sparkles, red ribbon accents and a glossy award-ceremony atmosphere; luxurious, energetic and high-contrast, never a food advertisement',
    frame: [
      'a wide tilted ceremonial red ribbon spans the top edge and holds the speech-bubble hook in bold ivory Korean lettering',
      ...
      'the headline sits directly below the emblem in two huge stacked lines, centred, with a thick ivory outline and gold shadow',
      'the supporting line sits in a narrow gold rule area under the headline',
      'the big number line or event-benefit line explodes across the lower third in oversized red lettering with ivory outline and a heavy black shadow',
      'the check items are small gold seal-like labels arranged in one neat row above the bottom CTA bar',
      'a full-width deep red CTA bar anchors the very bottom, with ivory lettering and small gold trim',
    ],
    prop: 'as small abstract gold seal accents only; do not add another product, package, bottle, box, food, ingredient or invented logo',
  },
  {
...
function promptOf({ product, concept, copy, subject }) {
  ...
  return [
    ...
    ...(concept.usesEmblem ? [
      ...
      'The attached emblem must be included as the central hero visual. If no emblem image is attached, do not invent an award seal, certificate, medal, logo or badge; leave the central hero area to the written headline and gold ceremonial light only.',
    ] : []),

...
6) "${HEAD_MARK} ${objectionHead}" 문단 — 한계를 솔직히 씁니다. **소제목을 이 문구 그대로 쓰세요.**
7) "${HEAD_MARK} ${closingHead}" 문단 — 허용된 마무리 문장을 원문 그대로 한 줄 쓰고, 접수·확인 안내를 덧붙입니다.
   **소제목을 이 문구 그대로 쓰세요.** "정리하면", "마치며" 로 바꾸지 마세요.

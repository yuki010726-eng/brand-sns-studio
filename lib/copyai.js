...
다만 **길게 쓰라는 뜻이 아닙니다.** 한 항목당 3~5줄이면 충분합니다. 짧고 정확한 쪽이 낫습니다.

■ 밀도: **짧은 것과 빈약한 것은 다릅니다.** 3~5줄 안에 알맹이를 넣으세요.
...
2) 시작하는 글 — **짧은 3문단, 전체 6~9줄.** 이 글에서 무엇을 다룰지 자연스럽게 예고합니다.
   첫 문단은 독자가 쉽게 떠올릴 수 있는 일상의 선택이나 상황에 빗대어 문을 엽니다.
   둘째 문단은 사람·브랜드·상황마다 맞는 답이 다르다는 점을 짧게 보여 줍니다.
   셋째 문단은 **이 글에서 비교·설명·정리할 범위와, 끝까지 읽으면 무엇을 판단할 수 있는지** 분명히 말합니다.
   비유가 어색한 주제라면 억지로 만들지 말고, 독자가 겪는 익숙한 상황으로 시작합니다.
   문단 사이에는 빈 줄을 넣습니다. **인사말·자기소개·근거 없는 업계 배경으로 시작하지 않습니다.**
   시작하는 글 안에서 위 「주제에 대한 답」도 짧게 제시하되, 본문의 세부 내용을 미리 나열하지 않습니다.
...
각 줄은 그 카드가 대응하는 단락 **바로 뒤**에 둡니다.
  표지 → **목차가 모두 끝난 뒤** / 본문 → 해당 소제목 문단 뒤 / 반론 → 한계 단락 뒤
  마무리 → **마무리 소제목 앞** (글이 이미지로 끝나지 않게 합니다)

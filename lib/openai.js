...
export const TEXT_MODELS = [
  { id: 'gpt-5.6-luna', label: 'GPT-5.6 Luna (저렴)', note: '입력 $0.20 / 출력 $1.20 per 1M. 게시물 1세트에 약 $0.008.' },
  { id: 'gpt-5.6-terra', label: 'GPT-5.6 Terra (균형)', note: '입력 $2 / 출력 $12 per 1M. 게시물 1세트에 약 $0.08.' },
  { id: 'gpt-5.6-sol', label: 'GPT-5.6 Sol (고품질)', note: '입력 $5 / 출력 $30 per 1M. 게시물 1세트에 약 $0.19.' },
];

...
export const POST_KEYS = [
  'productId', 'topic', 'libraryTitle', 'tone', 'customStyleUrl', 'customStyleGuide', 'customStyleGuideUrl', 'channels', 'cardCount',
...
export async function saveToLibrary(state, thumbBlob = null) {
  ...
  const at = editingAt >= 0 ? editingAt : before.findIndex((it) => it.postKey === key);

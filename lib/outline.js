...
function buildPrompt(ctx, retryNote) {
  ...
  return [
    ...
    `  "hook": "첫 문장에 쓸 후킹 한 줄. **${HOOK_MAX}자 이내** — 카드 표지 제목으로 그대로 얹히므로 길면 줄이 갈라집니다. 각도와 직결된 한마디만. ⚠️ **얻는 것·알게 되는 것으로 씁니다.** '~인 줄 알았는데 아니다', '~는 안 됩니다' 처럼 부정으로 열면 첫 줄이 상품을 부정하는 말이 되어 실패입니다.",`,

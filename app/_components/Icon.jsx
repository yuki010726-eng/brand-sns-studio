const PATHS = {
  ...
  refresh: (
    <>
      ...
      <path d="M3 12a9 9 0 0 0 15 6.7l3-2.7M16 16h5v5" />
    </>
  ),
  undo: (
    <>
  ...
  external: (
    <path d="M15 3h6v6m0-6L10 14m8-1v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
  ),
  ...
  eye: (
    <>
      <path d="M2.1 12.3a1 1 0 0 1 0-.6 10.8 10.8 0 0 1 19.8 0 1 1 0 0 1 0 .6 10.8 10.8 0 0 1-19.8 0Z" />
  ...
  thread: (
    <>
      <path d="M12 21c5 0 8-3.2 8-8.4C20 6.4 17 3 12 3S4 6.4 4 12.6C4 18 7 21 12 21z" />
      <path d="M9 13.4c0 1.6 1.3 2.5 2.9 2.5 2.2 0 3.4-1.3 3.4-4.4 0-2.4-1.4-3.7-3.2-3.7-1.3 0-2.3.6-2.8 1.5" />
    </>
  ),
  user: (
    <>
  ...
  // 블로그 미리보기 이미지 정렬(왼쪽·가운데·오른쪽) — 3단계 편집기에서 쓴다.
  alignLeft: (
    <>
  ...
  // 카드형 우상단 마크 5종 (lib/concepts.js 의 MARKS) — id 를 그대로 이름으로 쓴다.
  newspaper: (
    <>
      <path d="M15 18h-5" />
      <path d="M18 14h-8" />
...
export function Icon({ name, className = "size-6" }) {
  return (
    <svg
      className={`shrink-0 fill-none stroke-current stroke-[1.5] ${className}`}
      viewBox="0 0 24 24"
      aria-hidden="true"
      focusable="false"
      strokeLinecap="round"
